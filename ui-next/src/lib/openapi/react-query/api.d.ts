...
export interface paths {
  ...
  "/admin/feeds/{id}/fetch-history": {
    ...
    /** List fetch history for a feed (admin) */
  ...
  "/admin/tasks/fix-unread-drift": {
    ...
    get?: never;
    put?: never;
    /** Recalculate unread counts for all subscriptions from ground truth */
    post: operations["admin_fix_unread_drift"];
    delete?: never;
    options?: never;
    head?: never;
    patch?: never;
